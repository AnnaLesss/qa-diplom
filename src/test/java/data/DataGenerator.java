...
public class DataGenerator {
    public static Card getValidCard() {
        return new Card("4444 4444 4444 4441", "12", "24", "Card Holder", "123");
    }

    public static Card getDeclinedCard() {
        return new Card("4444 4444 4444 4442", "12", "24", "Card Holder", "123");
    }

    public static Card getFakeCard() {
        return new Card("4444 4444 4444 4447", "12", "24", "Card Holder", "123");
    }

    public static Card getInvalidHolderCard() {
        return new Card("4444 4444 4444 4441", "12", "24", "123456789Йцукенгшщзхъ!\"№;%:?*()123456789Йцукенгшщзхъ!\"№;%:?*()", "123");
    }
